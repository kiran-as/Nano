...
$studentSql = mysql_query("Select idstudent,rvvlsiid,firstname,lastname,email,mobile,resumeid,profilepic,updated_date,placed from tbl_student where rvvlsiid!='' and rvvlsiid!='0' and pgdip_schoolname='1'");
$i=0;
