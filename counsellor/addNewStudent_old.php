    ...
    <div class="fixed-nav">
       <nav class="container">
            <ul class="nav nav-pills">
              <li role="presentation" class="active"><a href="#" data-toggle="modal" data-target="#About_us">About Us</a></li>
              <li role="presentation" class="active"><a href="#" data-toggle="modal" data-target="#Placement">Placement</a></li>
              <li role="presentation" class="active"><a href="#" data-toggle="modal" data-target="#Courses">Courses</a></li>
            </ul>
       </nav> 
       </div>       
...
ntrol-label">Reason<span class="error-text">*</span></label>
    ...
    <!-- Div modal pop up for About us-->
  <div class="modal fade mar-t70" id="About_us" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="row hmar5 padt10">
                RV group of educational institutions a leader in the education field since 1940 and Nanochip Solutions Private Limited a pioneer in skill development and experiential learning joined to setup RV-VLSI Design Center In 2005. RV-VLSI is located in the heart of the city (in Jayanagar 4th T Block, Bangalore) . It is easily accessible from all parts of the city. The RV group of educational institutions manage 27 other RV institutes including the RV College of Engineering in Bangalore.                                                              
            </div>
      </div>
    </div>
  </div>
</div> 
<!-- DIV ends here for about us pop up-->

    <!-- Div modal pop up for About us-->
  <div class="modal fade mar-t70" id="Placement" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<!-- DIV ends here for about us pop up-->
    ...
    <!-- Div modal pop up for About us-->
  <div class="modal fade mar-t70" id="Courses" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
