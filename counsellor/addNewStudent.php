...
<div class="row">
 ...
 <div class="form-group" id="degotherschoolcoursename" style='display:none'>
      ...
      <div class="form-group">
        <label class="col-sm-5 control-label">Have you taken any other professional courses?<span class="error-text">*</span></label>
        <div class="col-sm-7">
...
<select class="form-control" id="primary_reason" name="primary_reason">
 ...
 <div class="form-group">
      ...
      <div class="form-group">
        <label class="col-sm-5 control-label">How many weeks can you spare?<span class="error-text">*</span></label>
        <div class="col-sm-7">
              <select class="form-control" id="weeks_spare" name="weeks_spare">
...
<option value="West Bengal">West Bengal</option>        
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        <label class="col-sm-5 control-label">Do you have a job offer in hand from campus?<span class="error-text">*</span></label>
        <div class="col-sm-7">
      ...
      <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-5 control-label">Joining Date<span class="error-text">*</span></label>
                <div class="col-sm-7">
                  <input type="name" class="form-control" placeholder="" id="joboffer_joining_date" name="joboffer_joining_date" value="">
                </div>               
              </div>
              <div class="form-group">
                <label class="col-sm-5 control-label">CTC<span class="error-text">*</span></label>
                <div class="col-sm-7">
      ...
      <div id="jobofferDivNO" style="display:none">
       ...
       <div class="form-group">
        <label class="col-sm-5 control-label">Are you expecting a job ?<span class="error-text">*</span></label>
        <div class="col-sm-7">
