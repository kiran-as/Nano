...
while($row = mysql_fetch_assoc($CollegeSql))
{
    ...
    $deg_schoolname = str_replace("&#39;","'",strtoupper($row['deg_schoolname']));
    $deg_university = str_replace("&#39;","'",strtoupper($row['deg_university']));
    $deg_state = str_replace("&#39;","'",strtoupper($row['deg_state']));
