...
if($_POST)
{
     $deg_projectname = str_replace("'","&#39;",$_POST['deg_projectname']);
    $deg_projectdescription = str_replace("'","&#39;",$_POST['deg_projectdescription']);
    $deg_projecttools = str_replace("'","&#39;",$_POST['deg_projecttools']);
    $deg_projectchallenges = str_replace("'","&#39;",$_POST['deg_projectchallenges']);
    
    $pg_projectname = str_replace("'","&#39;",$_POST['pg_projectname']);
    $pg_projectdescription = str_replace("'","&#39;",$_POST['pg_projectdescription']);
    $pg_projecttools = str_replace("'","&#39;",$_POST['pg_projecttools']);
    $pg_projectchallenges = str_replace("'","&#39;",$_POST['pg_projectchallenges']);
