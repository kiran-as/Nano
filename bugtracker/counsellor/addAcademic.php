...
function otherpgcoureseshideshow(pgothercoursename)
{
  ...
  <?php include('include/header.php');?>
   ...
   <ul class="col-sm-2 lhs-list">
      <li><a href="addAdmission.php?idstudent=<?php echo $idstudent;?>">Personal Info</a></li>
      <li  class="active"><a href="addAcademic.php?idstudent=<?php echo $idstudent;?>">Academic</a></li>
    </ul>     
