...
$studentdetails = mysql_query(("Select a.* from tbl_rvstudent as a 
...
$me_subject = $row['me_subject'];
 ...
 $course_by_counsellor = $row['course_by_counsellor'];
}

$enquirySql = mysql_query("Select reviewname from tbl_reviewstatus
  where idreviewstatus='$enquiry_from'");
while($rowss = mysql_fetch_assoc($enquirySql)) {
  $enquiryFromLable = $rowss['reviewname'];
}
...
$twelth_details = str_replace("'","&#39;",$_POST['twelth_details']);
  ...
  $deg_passoutyear = str_replace("'","&#39;",$_POST['deg_department']);
  ...
  $me_subject = str_replace("'","&#39;",$_POST['me_subject']);
      ...
      $expecting_joboffer_company_name = 
      str_replace("'","&#39;",$_POST['expecting_joboffer_company_name']);
 ...
 $friendsname = str_replace("'","&#39;",$_POST['friendsname']);
  ...
  $enquiry_from = str_replace("'","&#39;",$_POST['enquiry_from']);
  $course_by_counsellor = str_replace("'","&#39;",$_POST['course_by_counsellor']);

mysql_query("Delete from tbl_rvstudent where idrvstudent='$studentId'");

$firstSql= "Insert into tbl_rvstudent 
  ...
  mysql_query("Insert into tbl_rvstudent 
    (weeks_spare,studenttype,idrvstudent, friendsname, professor_name, keywords,name,phone,came_through,sslc_passoutyear,tenth_percentage,
      ...
      education_gap_reason,joboffer_company_name,joboffer_joining_date,
      joboffer_ctc,expectingjob,expecting_joboffer_company_name,me_college_name,
      me_university_name,be_college_name,be_university_name,twelth_details,enquiry_from,course_by_counsellor)
...
if($review_status=='15') {
  $step = '4';
   ...
   mysql_query("Update tbl_rvstudent set idcouncellor='$assignCouncellor',step='$step' where
...
if($step=='2') {
 echo "<script>alert('Data has been updated and can review in Follow up Menu')</script>";
}
if($step=='3') {
 echo "<script>alert('Data has been updated and can review in Application Bought Menu')</script>";
}
if($step=='4') {
 echo "<script>alert('Data has been updated and can review in Adavnce Payment')</script>";
}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-7">
                    <label class="radio-inline">
                      <input type="radio" name="deg_percentagetype" id="deg_percentagetype" value="Percentage" <?php if($deg_percentagetype=='Percentage'){ echo "checked=checked";};?>> Percentage
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="deg_percentagetype" id="deg_percentagetype" value="CGPA" <?php if($deg_percentagetype=='CGPA'){ echo "checked=checked";};?>> CGPA(out of 10 points)
                    </label>        
 ...
 <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-7">
                    <label class="radio-inline">
                      <input type="radio" name="pg_percentagetype" id="pg_percentagetype" value="Percentage" <?php if($pg_percentagetype=='Percentage'){ echo "checked=checked";};?>> Percentage
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="pg_percentagetype" id="pg_percentagetype" value="CGPA" <?php if($pg_percentagetype=='CGPA'){ echo "checked=checked";};?>> CGPA(out of 10 points)
                    </label>        
                    <input type="text" class="form-control mar-t10" placeholder="" id="pg_percentage" name="pg_percentage" value="<?php echo $pg_percentage;?>">                                                      
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-5 control-label">Seat Type<span class="error-text">*</span></label>
             ...
             <?php for($i=0;$i<count($councellorArray);$i++)
             {
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enquiry From : <?php echo $enquiryFromLable;?>
                    Opted Course : <?php echo $course_by_counsellor;?>
