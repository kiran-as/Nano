...
if($_POST)
{
   ...
   echo "<script>parent.location='addAdmission.php'</script>";
        exit; 
...
<script src="//ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js"></script>
 ...
 $(document).ready(function() {
  ...
  <?php include('include/header.php');?>
    ...
    <div class="row">
    <ul class="col-sm-2 lhs-list">
      <li class="active"><a href="addAdmission.php?idstudent=<?php echo $idstudent;?>">Personal Info</a></li>
      <li><a href="addAcademic.php?idstudent=<?php echo $idstudent;?>">Academic</a></li>
    </ul>    
    
    <div class="form-horizontal col-sm-5 brd-left">
