...
$studentSql = mysql_query("Select a.*,b.company,b.idrecruiter from tbl_recruitement as a ,tbl_recruiter as b
	                        where a.idrecruiter=b.idrecruiter and a.status='Review'");
$i = 0;
...
<script type="text/javascript">
    ...
    function fnRejectResume()
    {
        var idrecruitement = $('#rejecteResume').val();
        formData = 'idrecruitement=' + idrecruitement + '&type=Approve&Status=Reject';
		$.ajax({
     ...
     function fnApproveResume(idrecruitement)
    {
        //var idrecruitement = $('#rejecteResume').val();
...
<td>
                        <a href="#" class="btn btn-primary btn-sm " onclick="fnApproveResume(<?php echo $idrecruitement; ?>);">Approve.</a>
<button type="button" class="btn btn-secondary btn-sm mar-l5" data-toggle="modal" data-target="#myModal" onclick="rejectResumeId(<?php echo $idrecruitement; ?>)">Reject</button>
                    </td> 
    ...
    <input type='text' id='rejecteResume' name='rejecteResume' val=''>
    <!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <textarea name='rejectreason' id='rejectreason' style="height: 114px;
    width: 564px;"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="fnRejectResume();">Rejected</button>
      </div>
    </div>
