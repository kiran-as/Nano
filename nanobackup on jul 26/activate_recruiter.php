...
<td width="62%">
 ...
 <td class="text" align="left">Activation Code :&nbsp;</td><td><input name="activ_code" type="password" class="required" id="txtboxn1" size="25">
   ...
   <input name="doActivate" type="submit" id="doLogin3" value="" style="background-image:url(images/activate_img.png); background-repeat:no-repeat; width:82px; height:22px; border:none;">
