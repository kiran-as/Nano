...
$info_query="update $members_table set md5_id='$md5_id' where m_id='$user_id'";
...
";
$headers1 =    "From: \"RV-VLSI Member Activation\" <auto-reply@$host>\r\n" ;
...
<div class="rightimg_right">
 ...
 <div class="stmenurightinner_content_inner" style="margin-bottom:-10px;">
    ...
    <tr>
     ...
     <td><?=$input->textBox('txtFirstName',$_REQUEST[txtFirstName],'','style=width:235px;','');?></td>
...
<tr>
 ...
 <td><?=$input->textBox('txtLastName',$_REQUEST[txtLastName],'','style=width:235px;','');?> </td> 
...
<td width="275" height="25"><input type="text" name="txtEmail" id="txtEmail" value="<?=$_REQUEST[txtEmail];?>" style="width:236;" onBlur="showUser(this.value);" /></td> 
...
<td><?=$input->textBox('txtEmailConfirm',$_REQUEST[txtEmailConfirm],'','style=width:235px;','');?></td>
<td><span class="error">*</span></td>
</tr>
...
<tr>
 ...
 <td><?=$input->password('txtPassword','','text','style=width:235px;','');?></td>
 <td><span class="error">*</span></td>
  </tr>          
...
<tr>
    ...
    <td><?=$input->password('txtConfirmPassword','','text','style=width:235px;','');?></td>
	<td><span class="error">*</span></td>
</tr>	
...
<tr>
    <td width="275" height="15"  class="text">Address For Communication :</td>
    <td><?=$input->textArea('txtAddress',$_REQUEST[txtAddress],'text','style=width:235px;height:80px;','');?></td>
	<td><span class="error">*</span></td>
</tr> 	
 <tr>
<td width="275" height="25"  class="text">City :</td>
<td><input type="text" name="txtCity"   value="<?=$_REQUEST[txtCity]?>" style="width:235px;" maxlength="20"/></td>
 <td><span class="error">*</span></td>
</tr>
<tr>
    <td width="185" height="25"  class="text" align="left">Pin Code :</td>
    <td width="199"><input type="text" name="txtPinCode" value="<?=$_REQUEST[txtPinCode]?>"  id="txtPinCode" style="width:200px;"  maxlength="6" /><td class="error">*</td></td>
</tr>  
<tr>

<td width="275" height="25"  class="text">State :</td>
 <td  height="19"><div id="selDiv"><select name="selState" id="selState"  style="width:150px;">
...
<td width="275" height="25"  class="text">Country :</td>
 <td  height="19">
 <select name="selCountry"  id="selCountry" style="width:150px;" onChange="changeState(this.value)">
...
<tr>
    ...
    <td width="199"><input type="text" name="txtFathername" id="txtFathername"  value="<?=$_REQUEST[txtFathername]?>" style="width:200px;"   /></td>
</tr>
	 <tr>
    <td width="185" height="25"  class="text" align="left">Marital Status:</td>
    <td width="199"><input type="text" name="txtMartialStatus" id="txtMartialStatus" value="<?=$_REQUEST[txtMartialStatus]?>" style="width:200px;" maxlength="10"  /></td>
</tr>
 <tr>
    <td width="185" height="25"  class="text" align="left">Nationality:</td>
    <td width="199"><input type="text" name="txtNationality" id="txtNationality"  value="<?=$_REQUEST[txtNationality]?>" style="width:200px;"  maxlength="10" /></td>
</tr>
 <tr>
    <td width="185" height="25"  class="text" align="left">Languages Known:</td>
    <td width="199"><input type="text" name="txtLanguages" id="txtLanguages"  value="<?=$_REQUEST[txtLanguages]?>" style="width:200px;"  maxlength="30" /></td>
</tr>
   ...
   <tr>
    ...
    <td width="199"><input type="text" name="txtPhoneNumber" id="txtPhoneNumber"  value="<?=$_REQUEST[txtPhoneNumber]?>" style="width:200px;"  maxlength="10" /><td class="error">*</td></td>
</tr> 

 
 <tr>
    <td width="185" height="25"  class="text" align="left">STD Code/Contact No :</td>
    <td ><input type="text" name="txtStdCode" id="txtStdCode" value="<?=$_REQUEST[txtStdCode]?>" style="width:50px;"  maxlength="4" />
	<input type="text" name="txtContactNo" id="txtContactNo"  value="<?=$_REQUEST[txtContactNo]?>" style="width:175px;"  maxlength="8" /><td class="error">*</td></td>
</tr> 
...
<td><input type="text" name="txtHobbies"   value="<?=$_REQUEST[txtHobbies]?>" style="width:235px;" /></td>
 <!--<td><span class="error1">*</span></td>-->
</tr>
...
<img src="Captcha.php" width="50" height="24" align="absbottom" /><br />
  ...
  <tr>
    ...
    <td  height="19" colspan="2">
      ...
      <?=$input->submitButton('regSubmit','Register','text', 'style=background-color:#424843;color:#ffffff');?>
      <!--<input  style="color: rgb(8, 96, 168); font-weight: bold; font-family: calibri;" type="submit" name="regSubmit"  value="Register"/>-->
            <?=$input->ResetButton('Reset','Reset','text','style=background-color:#424843;color:#ffffff');?>
