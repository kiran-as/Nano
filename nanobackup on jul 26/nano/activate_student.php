...
<div class="rightimg_right">
 ...
 <tr><td colspan="3" >
	...
	if(!empty($err))  {
     ...
     <p  class="text"> Thanks for registering with us , <br /><br />
     Please enter the Activation Code provided to your email id  to activate your account. Check  spam of email account to read RV-VLSI member activation mail..</p></td></tr>
