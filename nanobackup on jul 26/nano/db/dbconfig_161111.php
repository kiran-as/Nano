...
// $student_10th=$db->getResults("select * from rv_educational_details where m_id='".$m_id."' and qua_id='5'");
 ...
 $student_10th=$db->getResults("select * from rv_educational_details1 where m_id='".$m_id."' and qua_id='10th'");
...
$rv_marks+=5;
 ...
 $student_12th=$db->getResults("select * from rv_educational_details1 where m_id='".$m_id."' and qua_id='12th'");
...
//  $student_dep=$db->getResults("select * from rv_educational_details where m_id='".$m_id."' and qua_id='3'");
    ...
    $student_dip=$db->getResults("select * from rv_educational_details1 where m_id='".$m_id."' and qua_id='Diploma'");
...
//  $student_graduation=$db->getResults("select * from rv_educational_details where m_id='".$m_id."' and qua_id='2' and (cor_id!=25 or cor_id!=26)");
    ...
    $student_graduation=$db->getResults("select * from rv_educational_details1 where m_id='".$m_id."' and qua_id='BE/Btech'");
