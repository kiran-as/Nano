 	...
 	$insert_query="INSERT INTO $rec_table  set r_user_name	='".$ch->checkFields($_POST['txtUserName'])."',
									                ...
									                r_address ='".$ch->checkFields($_POST['txtAddress'])."',
													  ...
													  r_std ='".$ch->checkFields($_POST['txtStdCode'])."',
														...
														r_no_employes	='".$ch->checkFields($_POST['txtNofEmployes'])."'"; 
...
$result=$db->insertRecord($info_query);
	 ...
	 $headers  = 'MIME-Version: 1.0' . "\r\n";
				...
				$headers .= 'From: rvvlsi - Registration' . "\r\n";
				
		        $to='bhimashankar@kaivalyasoftware.com';
...
";
$headers1 =    "From: \"RV-VLSI Recruiter Activation\" <auto-reply@$host>\r\n" ;
...
<div class="rightimg_right">
 ...
 <div class="stmenurightinner_content_inner" style="margin-bottom:-10px;">
   <?=$input->formStart('txtForm_rec','','onsubmit="return RecruitersValidation();"');?>
   	    <table width="100%"  align="center" class="recruit_menu_bg" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">   
  
	
    <tr>
       <td width="229" height="34" align="center"><span class="error">&nbsp;</span></td>
      <td width="204" height="34" align="center" class="error">
        <? $msg=new messages();
		  echo $msg->success($_REQUEST[success]); ?></td>
      <td width="163"><span class="error"> * Indicates required field</span></td>
    </tr>
  
    <tr>
     <td width="229" height="1"  class="text"> Name : </td>
     <td><?=$input->textBox('txtUserName',$_REQUEST[txtUserName],'','style=width:200px;','');?></td>
 ...
 <tr>  
<td width="229" height="25"  class="text"> Email ID : </td>
<td><input type="text" name="txtEmail" value="<?=$_REQUEST[txtEmail]?>" onBlur="return validEmail(this.value)"  style="width:200px;"/><? //=$input->textBox('txtEmail',$_REQUEST[txtEmail],'','style=width:200px;','');?></td>
<td><span class="error">*</span></td>
</tr>
...
<tr>
 <td width="229" height="25"  class="text">Password:</td>
 <td><?=$input->password('txtPassword','','text','style=width:200px;','');?></td>
  <td><span class="error">*</span></td>
  </tr>          

<tr>
    <td width="229" height="15"  class="text">Confirm Password:</td>
    <td><?=$input->password('txtConfirmPassword','','text','style=width:200px;','');?></td>
    <td><span class="error">*</span></td>	
 </tr>
  
<tr>
 <td width="229" height="15"  class="text">Company Name :</td>
 <td><?=$input->textBox('txtCompany ',$_REQUEST[txtCompany ],'','style=width:200px;','');?></td>
 <td><span class="error">*</span></td>
</tr>
...
<tr>
    <td width="229" height="15"  class="text">Company Address:</td>
    <td><?=$input->textArea('txtAddress','','text','style=width:200px;','');?></td>
	<td><span class="error">*</span></td>
</tr>   


<tr>
<td width="229" height="25"  class="text">Country :</td>
<td><input type="text" name="txtCountry"  id="suggest2" value="" style="width:200px;" /></td>
<td><span class="error1">*</span></td>
</tr> 

<tr>
<td width="229" height="25"  class="text">State :</td>
<td><input type="text" name="txtState"  id="suggest1" value="" style="width:200px;" /></td>
 <td><span class="error1">*</span></td>
</tr> 
...
<tr>
<td width="229" height="25"  class="text">City :</td>
<td><input type="text" name="txtCity"  id="suggest0" value="" style="width:200px;" /></td>
 <td><span class="error1">*</span></td>
</tr>

<tr>
 <td width="229" height="15"  class="text">Pin Code :</td>
 <td><?=$input->textBox('txtPinCode',$_REQUEST[txtPinCode],'','style=width:200px;','');?></td>
 <td> <span class="error">*</span>
</tr>

<tr>
 <td width="229" height="1"  class="text">Designation: </td>
 <td><?=$input->textBox('txtDesignation',$_REQUEST[txtDesignation],'','style=width:200px;','');?></td>
  <td><span class="error">*</span></td>
</tr>

<tr>
<td width="229" height="25"  class="text">STD Code/Contact No :</td>
<td><?=$input->textBox('txtStdCode','','','style=width:50px;','');?>&nbsp;&nbsp;<?=$input->textBox('txtContactNo','','','style=width:135px;','');?></td>
<td><span class="error1">*</span></td>
</tr> 
...
<?php */?>
  <tr>
<td width="229" height="25"  class="text">Mobile Number:</td>
<td><?=$input->textBox('txtPhoneNumber',$_REQUEST[txtPhoneNumber],'','style=width:200px;','');?></td>
<td><span class="error">*</span></td>
</tr>  
       
 <tr>
<td width="229" height="25"  class="text">Web Site Url:</td>
<td><?=$input->textBox('txtWebUrl',$_REQUEST[txtWebUrl],'','style=width:200px;','');?></td>
<td><span class="error">*</span></td>
</tr>
 
<tr>
    <td width="229" height="15"  class="text">Company Description:</td>
    <td><?=$input->textArea('txtComDescriptn','','text','style=width:200px;','');?></td>
    <td><span class="error">*</span></td>
</tr> 

<tr>  
<td width="229" height="25"  class="text">Type of Industry : </td>
<td><?=$input->textBox('txtIndustry',$_REQUEST[txtIndustry],'','style=width:200px;','');?></td>
<td><span class="error">*</span></td>
</tr>

<tr>  
<td width="229" height="25"  class="text">Number of Employees : </td>
<td><?=$input->textBox('txtNofEmployes',$_REQUEST[txtNofEmployes],'','style=width:200px;','');?></td>
<td><span class="error">*</span></td>
</tr>
  ...
  <tr>
    ...
    <input  type="submit" class="button" value="Register" name="regSubmit" />&nbsp;<input  type="Reset" class="button" value="Reset" name="Reset" />
