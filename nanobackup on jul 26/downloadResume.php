...
$designation = $companyArray[$i]['designation'];
 ...
 $table.=" <br/> <table width='100%' border='0' style='border-collapse:collapse;'>";
          ...
          {
            $table.="<tr>
                 <td width='20%'  style='font-weight:bold'>Worked At</td>
                 <td width='80%'>$college_name</td>
            </tr>";
          }
          if(!empty($project_description))
          {
            $table.="<tr>
                 <td width='20%'  style='font-weight:bold'>Project Deliverables</td>
                 <td width='80%'>$project_description</td>
            </tr>";
          }
          if(!empty($tools_used))
...
if($deg_projectname!=''){ 
  ...
  $table.="<tr>
            ...
            <tr>
                 <td width='20%' style='font-weight:bold'>College Name</td>
