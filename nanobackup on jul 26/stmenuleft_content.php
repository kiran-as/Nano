...
<p  class="left_para" style="margin:0px;padding:0px;"><?  if($img=="free_resume_builder_edit.png"){?>
<tr>  
<td><a href="resume.php" class=""><img src="images/viewresume_img.png" border="0"></img></a></td>
</tr> 
<? }?>
</p>
<p class="dot_style"></p>
