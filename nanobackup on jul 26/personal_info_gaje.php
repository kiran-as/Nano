...
<div class="step-inner-Divgaje" >
<br/>
<div class="step-sub-tabsgaje">Personal Information</div><div class="step-sub-tabs" style="float:right;">Resume Bulider:Steps - 1/5 </div>
...
<td class="error1">*</td>
 ...
 <tr>
   ...
   <td  width="203" valign="middle">
  	  <input type="submit" name="infoUpdate" id="infoUpdate" value="Update" class="button_new"></td>
