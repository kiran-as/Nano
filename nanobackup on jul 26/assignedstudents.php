		...
		<tr class="alternaterowcolor1">
		 <td colspan="4">
		       <table border="0" width="100%">
				   ...
				   <?php if ($sendus==1){?>
	  <td><span align="left" class="smalltext">To request the Nanochip Solutions Admin to assist in setting up an interview for your shortlisted students, please select the students in the above list and click on "Send Us". The admin will call you back to set up the interview</span>
</td>
	  <td>
