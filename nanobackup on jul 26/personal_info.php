...
<div class="main_content">
  ...
  <ul id="menu">
   <li><a href="personal_info.php" title="Personal Information"    class="current">Personal Information</a></li>
...
<form name="formPersonal" id="formPersonal" value="formPersonal" action="personal_info.php" method="post" onsubmit="return general_Validation();">
