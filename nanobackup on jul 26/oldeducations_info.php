 ...
 $query = "SELECT * FROM $members_table where m_id='".$_SESSION[m_id]."'"; 
  ...
  if(isset($_POST[submit10])){
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	    ...
	    header("Location:educations_info.php?msg=2&tb=1#tabs-2");
	  }
...
if(isset($_POST[submit12])){
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	    ...
	    header("Location:educations_info.php?msg=2&tb=2#tabs-3");
	  }
...
if(isset($_POST[GradSubmit])){
	...
	else
	{
	 ...
	 $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	   ...
	   header("Location:educations_info.php?msg=2&tb=3#tabs-4");
	  }
...
if(isset($_POST[updatePG])){
	...
	else
	{
	  ...
	  $db->insertRecord("update  $education_table  set 
	     ...
	     header("Location:educations_info.php?msg=2&tb=4#tabs-5");
	  }	  
if(isset($_POST[PGDipSubmit])){
	...
	else
	{
	  ...
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	   ...
	   // header("Location:educations_info.php?msg=2&tb=5#tabs-6");
...
if(isset($_POST[OtherSubmit])){
	  ...
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	    ...
	    header("Location:educations_info.php?msg=2&tb=6#tabs-7");
	  }
            ...
            -->
                      <tr>
                        ...
                        <td><? if(count($results10)==0){?>
                            <input type="submit" name="submit10" value="" class="button_sc" />
                          &nbsp;&nbsp;&nbsp;
                          <input type="reset" name="reset2" value=""  class="resetbutton" />
                          <? }else{?>
                          <input type="submit" name="update10" value=""  class="button_sc" />
                          <? }?>
            ...
            -->
                      <tr>
                        ...
                        <td><? if(count($results12)==0){?>
                            <input type="submit" name="submit12" value=""  class="button_sc" />
                          &nbsp;&nbsp;&nbsp;
                          <input type="reset" name="reset2" value=""  class="resetbutton" />
                          <? }else{?>
                          <input type="submit" name="update12" value=""  class="button_sc" />
                          <? }?>
                          <span style="font-size:11px; font-family:Trebuchet MS; color:#FF0000; padding-left:30px;">Save this section before filling up next.</span></td>
                      </tr>
          </table>
	...
	<?php */?></td>
            ...
            <tr>
              ...
              <td colspan="2" valign="top"><? if(count($resultsGrad)==0){?>
                  <input type="submit" name="GradSubmit" value="" class="button_sc"  />
                &nbsp;&nbsp;&nbsp;
                <input type="reset" name="reset2" value="" class="resetbutton"  />
                <? }else{?>
                <input type="submit" name="updateGrad" value=""  class="button_sc" />
                <? }?>
                <span style="font-size:11px; font-family:Trebuchet MS; color:#FF0000; padding-left:30px;">Save this section before filling up next.</span></td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="3" cellspacing="0" border="0">
            ...
            <tr>
              ...
              <td colspan="2" valign="top"><? if(count($resultsPG)==0){?>
                  <input type="submit" name="PGSubmit" value=""  class="button_sc" />
                &nbsp;&nbsp;&nbsp;
                <input type="reset" name="reset2" value="" class="resetbutton" />
                <? }else{?>
                <input type="submit" name="updatePG" value=""  class="button_sc" />
                <? }?>
                <span style="font-size:11px; font-family:Trebuchet MS; color:#FF0000; padding-left:30px;">Save this section before filling up next.</span></td>
            </tr>
          </table>
		  ...
		  ?>
            ...
            <tr>
              ...
              <td colspan="2" valign="top"><? if(count($resultsPGDip)==0){?>
                  <input type="submit" name="PGDipSubmit" value=""  class="button_sc" />
                &nbsp;&nbsp;&nbsp;
                <input type="reset" name="reset2" value="" class="resetbutton" />
                <? }else{?>
                <input type="submit" name="updatePGDip" value=""  class="button_sc" />
                <? }?>
                <span style="font-size:11px; font-family:Trebuchet MS; color:#FF0000; padding-left:30px;">Save this section before filling up next.</span></td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="3" cellspacing="0" border="0">
            ...
            <tr>
              ...
              <td valign="top"><? if(count($resultsOther_query)==0){?>
                  <input type="submit" name="OtherSubmit" value=""  class="button_sc" />
                &nbsp;&nbsp;&nbsp;
                <input type="reset" name="reset2" value=""  class="resetbutton" />
                <? }else{?>
                <input type="submit" name="updateOther" value=""  class="button_sc" />
                <? }?></td>
              <td valign="top">&nbsp;</td>
            </tr>
          </table>
...
<select name="selYearOthermore" id="selYearOthermore" style="width:80px;">
  ...
  <? }?>
		  ...
		  <tr><td valign="top">&nbsp;</td>
		    <td valign="top"><input type="submit" name="OthermoreSubmit" value=""  class="button_sc" />
&nbsp;&nbsp;&nbsp;
