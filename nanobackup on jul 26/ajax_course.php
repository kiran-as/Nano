<? include_once('db/dbconfig.php');
   ...
   $db->connectDB();
		...
		//dbconnect :: dbc();
		global $course_table;
		  $states_qry = "select * from $course_table where qua_id='".$_REQUEST['qua_id']."' and cor_status=1 order by cor_name asc";
		$states_qry = mysql_query($states_qry) or die('error at countries'.mysql_error());
			
		$states=  '<select name="selCourse" id="selCourse" style="width:150px;" class="drop_box" onchange="loadBranch(this.value);return false;">';
