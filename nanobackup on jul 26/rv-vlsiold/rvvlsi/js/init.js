								...
								&&	!skel.isActive('mobile')) {
									$('.fullscreen').each(function() {
										...
										var $t = $(this),
											...
											x = Math.max(112, Math.round(($window.height() - $c.outerHeight() - $header.outerHeight()) / 2) + 1);
							...
							// Resize fullscreen elements
								...
								&&	!skel.isActive('mobile')) {
									$('.style1').each(function() {
										...
										var $t = $(this),
											$c = $t.children('.content'),
											x = Math.max(30, Math.round(($window.height() - $c.outerHeight() - $header.outerHeight()) / 2) + 1);
