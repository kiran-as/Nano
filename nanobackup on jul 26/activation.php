...
<div class="rightimg_right">
 ...
 <div style="float:left; width:450px; background-color:#f3e1e1; border-left:1px solid #736f6f; border-right:1px solid #736f6f;">
    ...
    <h3 align="left" style="color:#114981;font-size:16px;font-weight:bold;margin:0px;padding-left:10px;">Job Seeker Activation</h3>  
  <tr><Td>
 ...
 <tr><td colspan="2" align="center">
	...
	if(!empty($err))  {
	 ...
	 <a href="job_seeker_login.php" class="mail_text">click here</a> to login  </p></td></tr>  
   <tr>
