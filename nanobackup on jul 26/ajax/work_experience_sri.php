...
var new_pr='<input type="hidden" name="work1" value="'+work+'" id="work1"><table width="100%"><tr><td  colspan="3">&nbsp;</td></tr><tr><td  colspan="3">Add Project Details</td></tr><tr><td height="25" colspan="3"></td></tr><tr><td width="192" height="1"  class="text" align="left">Title :</td><td width="197"><input type="text" name="txtTitle1" id="txtTitle1" value=""  style="width:200px;" /></td><td  height="1" width="209"><span class="error"> *</span></td></tr><tr><td width="192" rowspan="2" align="left"  class="text">Duration :</td><td height="15">From :&nbsp;<select name="selProjMonth" id="selProjMonth"><option value="0">month</option><? for($dp=0;$dp<count($month_array);$dp++){?><option value="<?=$dp?>"><?=$month_array[$dp]?></option><? }?></select>&nbsp;&nbsp;<select name="selProjYear" id="selProjYear"><option value="0">Year</option><? for($yp=date(Y);$yp>1970;$yp--){?><option value="<?=$yp?>"><?=$yp?></option><? }?></select></td><td width="209"><span class="error"> *</span></td></tr><tr><td>To :&nbsp;&nbsp;&nbsp; &nbsp;<select name="selProjMonth1" id="selProjMonth1"><option value="0">month</option><? for($dm=0;$dm<count($month_array);$dm++){?><option value="<?=$dm?>" ><?=$month_array[$dm]?></option><? }?>    </select>&nbsp;&nbsp;<select name="selProjYear1" id="selProjYear1<?=$works->we_id;?>"><option value="0">Year</option><? for($yy=date(Y);$yy>1970;$yy--){?><option value="<?=$yy?>" ><?=$yy?></option><? }?> </select></td><td  height="1">&nbsp;</td> </tr><tr><td width="192" height="1"  class="text" align="left">Role :</td><td width="197"><input type="text" name="txtRole1" id="txtRole1" value=""  style="width:200px;" /></td><td  height="1" width="209"><span class="error"> *</span></td></tr><tr><td width="192" height="1"  class="text" align="left">Team Size :</td><td width="197"><input type="text" name="txtTeam1" id="txtTeam1" value=""  style="width:200px;" /></td><td  height="1" width="209"><span class="error"> *</span></td></tr><tr><td   class="text" align="left" valign="top">Project Description :</td><td width="197"><textarea rows="4" cols="30" name="areaDescription1" id="areaDescription1"></textarea></td><td  height="" width="209"></td></tr><tr><td width="192" height="1" class="text" align="left" valign="top">Tools Used : </td><td width="197"><textarea rows="4" cols="30" name="areaTools1" id="areaTools1"></textarea></td><td  height="1" width="209"><p></p></td></tr><tr><td width="192" height="1"  class="text" align="left" valign="top">Challenges :  </td><td width="197"><textarea rows="4" cols="30" name="areaChallenges1" id="areaChallenges1" ></textarea></td><td  height="1" width="209"></td></tr><tr><td  height="19" width="192">&nbsp;</td><td height="19" colspan="2"><input type="button" name="projNew" value="Save" class="button" onclick="workExpInsertInUpdate(document.getElementById(\'work1\').value,document.getElementById(\'txtTitle1\').value,document.getElementById(\'areaDescription1\').value,document.getElementById(\'selProjMonth\').value,document.getElementById(\'selProjYear\').value,document.getElementById(\'selProjMonth1\').value,document.getElementById(\'selProjYear\').value,document.getElementById(\'txtRole1\').value,document.getElementById(\'txtTeam1\').value,document.getElementById(\'areaTools1\').value,document.getElementById(\'areaChallenges1\').value)" /> &nbsp; &nbsp; <input type="button" name="" value="Close" class="button" onclick="closeDIvID(\''+div_id+'\')" /></td></tr><tr><td colspan="3"><hr /></td></tr></table>';
  //  alert($("#"+div_id).html())
  //alert(totaldat);
