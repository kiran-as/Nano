  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
      ...
      <td  height=""  colspan="2"><img src="images/pixel_transparent.gif" width="550" height="1"><span ><a href="#" onclick="addcoreTextarea('text'); return false;"><img src="images/addnewbg.png" width="83" height="22" border="0"/></a></span></td>  
	</tr>   
 <tr>
...
<img src="images/pixel_transparent.gif" width="550" height="1"><span  class="addnewbg"><a href="#" onclick="addsecondTextarea('text'); return false;"><img src="images/addnewbg.png" width="83" height="22" border="0"/></a></span>
...
<!--kiran</form>-->
<DIV>
<input type="checkbox" name='disclaimer' id='disclaimer' onclick='disclaimerfunction()'>Disclaimer text appear here
...
<tr>
<td align="left"><input type="button" id='cancelinfo' name="cancelinfo" value="Save and Preview" class="blueButton"/></td>
<td align="right"><input type="submit" id='achivSubmit' name="achivSubmit" value="Save and Preview" class="blueButton"/></td>
</tr></table>
</div>
