<?php include_once('db/dbconfig.php');
 ...
 $query = "SELECT * FROM $members_table where m_id='".$_SESSION[m_id]."'"; 
  ...
  function abcmailfunction($crntempfct)
  {
										...
										header("Location:2_educations_info.php?msg=0&tb=2#tabs-2");
  }
   ...
   if(isset($_POST['hidId12']))
  {
       $db->insertRecord("update  $education_table  set 
		...
		header("Location:2_educations_info.php?msg=0&tb=3#tabs-3");
  ...
  if(isset($_POST[submit10])){
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	    ...
	    header("Location:2_educations_info.php?msg=0&tb=1#tabs-1");
	  }
...
if(isset($_POST[GradSubmit])){
	...
	else
	{
	 ...
	 $currentempfctr = (employabilityFactor($_SESSION[m_id]));
	    ...
	    {
	    	abcmailfunction($currentempfctr);
			  header("Location:2_educations_info.php?msg=0&tb=4#tabs-4");
	    }
	   header("Location:2_educations_info.php?msg=0&tb=4#tabs-4");
	  }
...
if(isset($_POST[PGSubmit])){
	...
	else
	{
	  ...
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	    ...
	    {
	    	abcmailfunction($currentempfctr);
			  header("Location:2_educations_info.php?msg=0&tb=5#tabs-5");
	    }
	    header("Location:2_educations_info.php?msg=0&tb=5#tabs-5");
	  }
...
if(isset($_POST[updateOther])){
	  $db->insertRecord("update  $education_table  set 
	     ...
	     header("Location:2_educations_info.php?msg=2&tb=6#tabs-6");
	  }	
if(isset($_POST[OthermoreSubmit])){
	  ...
	  $db->insertRecord("insert into  $education_table  set m_id			='".$ch->checkFields($_SESSION[m_id]) ."',
	    ...
	    header("Location:2_educations_info.php?msg=2#tabs-6");
	  }
...
if($_REQUEST[action]=='deleteOne' && is_numeric($_REQUEST[e_id])!=''){
 ...
 header("Location:2_educations_info.php?msg=3&tb=6#tabs-6");
}
...
<div class="recruit_inner">
      ...
      <a href="1_personal_info.php" style="text-decoration:none;"><li>
...
document.forms["form12"].submit();
      ...
      <ul>
        ...
        <li><a href="#tabs-2" onclick="asdf();">10+2</a></li>
      ...
      <div id="tabs-1">
        ...
        <form name="form10" id="form10" method="post" action="" onclick="return class10thvalidation();">
          <table width="100%" cellpadding="3" cellspacing="0" border="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input type="text" name="txtPer10" maxlength="5" style="height:20px; width:100px;" value="<?=stripslashes($results10[0]->e_percentage)?>" />
      ...
      <div id="tabs-2">
        ...
        <form name="form12" id="form12" method="post" action="" onsubmit="return class12thvalidation();">
          <table width="100%" cellpadding="3" cellspacing="0" border="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input type="text" name="txtPer12" maxlength="5" style="height:20px; width:100px;" value="<?=stripslashes($results12[0]->e_percentage)?>" />
...
?>
	...
	<?php */?></td>
            ...
            <tr>
              <td valign="top">&nbsp;</td>
              <td valign="top"><input type="text" name="txtPerGrad" maxlength="5" style="height:20px; width:100px;" value="<?=$resultsGrad[0]->e_percentage?>" /></td>
              <td valign="top"><span style="color:#FF0000;">*</span></td>
            </tr>
