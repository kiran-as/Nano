...
<header>
    ...
    <div class="row">
      <div class="col-sm-3">
        <label class="control-label"><span class="font-gray">Name :</span><?php echo $firstName.' '.$lastName;?></label> <br/>
        <?php if($rvvlsiid) { ?>
        <label class="control-label"><span class="font-gray">RV-VLSI ID :</span><?php echo $rvvlsiid?></label> <br/>
        <?php }?>
      </div>
      <div class="col-sm-3">
