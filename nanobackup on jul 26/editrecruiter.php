...
$resultsss = "SELECT * FROM rv_recruiters where r_id=".$_GET['idrecruiter'];
	...
	while ($row = mysql_fetch_assoc($resultc)) {
		  $arraStudent["r_user_name"]	= $row["r_user_name"];
		 $arraStudent["r_company"]	= $row["r_company"];
		 $arraStudent["r_mobile"]	= $row["r_mobile"];
		 $arraStudent["r_email"]	= $row["r_email"];
		 $arraStudent["r_designation"]	= $row["r_designation"];
...
function fnclose()
{
    parent.location="http://nanochipsolutions.com/admin1/admin_mangae_recruiters.php";
}
