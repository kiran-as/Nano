...
{
	$_SESSION['check'] = 0;
	header("Location:academic_info.php?flag=1");exit;  
//echo "<meta http-equiv='refresh' content='0';URL='http://nanochipsolutions.com/academic_info.php'>"; 
...
<ul id="menu">
   ...
   <li><a href="educations_info.php" title="Academic Qualification">Academic Qualification</a></li>
      ...
      <li><a href="academic_info.php" title="Academic Projects"      class="current">Academic Projects</a></li>
...
<a href="work_info.php" class="blueButton">Continue</a>
