...
$(document).ready(function(){
 /* var data = [
  ...
  var data = [
     ['B.E + Diploma Students', <?php echo $bediplomastudents;?>], ['B.E Students', <?php echo $bestudents;?>],['M.Tech Students', <?php echo $mtechstudents;?>], 
   ['M.Tech + Diploma Students',<?php echo $mtechdiplomastudents;?>],['Others', <?php echo $othersdegreestudents;?>]
  ];
  var plot1 = jQuery.jqplot ('chart1', [data], 
    { 
      seriesDefaults: {
		...
		seriesColors: [ "#0d9003", "#7f011d", "#938c59", "#ff7d0d" ,"#27458a"],
        rendererOptions: {
          // Put data labels on the pie slices.
          // By default, labels show the percentage of the slice.
			//seriesColors: [ "#6c8fa6", "#935984", "#008DFD", "#599393" ,"#498e2c","#9161a0"]
			showDataLabels: true
