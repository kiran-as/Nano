...
<div class="step-main-Div" >
       ...
       <div class="nanohdmid"><a href="personal_info.php"><img src="images/academic_qalification.png" width="127" height="32" align="absmiddle" border="0" style=" margin-top:8px;" /></a></div>
...
<?php */?>
 ...
 <td>&nbsp;</td>
   <td  height="19">&nbsp;</td>
   <td>
  	  <input type="submit" name="infoUpdate" id="infoUpdate" value="" class="button_new"></td>
  <td >&nbsp;</td>
 </tr>
 <tr> 
 <td>&nbsp;</td>  
    ...
    <td  height="19"> <td  align="right" ><a href="career_info.php" ><img src="images/continue.png" border="0" /></a></td> 
   </tr>
