...
<tr><td  colspan="6" align="left"><span style="font-family:verdana,Geneva, sans-serif; font-weight:bold;font-size:18px;">'.ucfirst($members->m_fname).'&nbsp;'.$members->m_lname.'</span><br/>
Email id: '.$members->m_emailid.'<br />
Mobile Number: '.$members->m_phone.'<br />
Resume id: '.$members->m_resume_id.'<br />
Employability Factor: '.employabilityFactor($members->m_id).'<br />
</td>
</tr>
...
$final_word.='CGPA '.stripslashes($alleducation->e_percentage).'/10';  
}	
...
$projects_result=$db->getResults($projects_query);
  foreach($projects_result as $projects){
	    	  ...
	    	  <tr>	<td  align="left" class="general-bodyBold"><strong>Duration of Project in Months</strong>:</td><td colspan="5">';
...
$from_proj=explode('-',$work_experience->we_from_date);
	...
	if(count($work_exp_result)!='0'){	
		$final_word.='    <tr>
<td style="font-family:Verdana, Geneva, sans-serif;font-weight:bold; font-size:14px; background-color:#999; height:25px;" colspan="6">Projects:</td></tr>';
...
/*  $from_exp=explode('-',$work_exp->wp_from_date);
 ...
 $to_exp=explode('-',$work_exp->wp_to_date);
		 ...
		 $final_word.='</td></tr>';}
$final_word.='<tr>	<td  align="left" class="general-bodyBold" valign="top"><strong>Role</strong>:</td><td colspan="5" style="text-align:justify;">'.stripslashes($work_exp->wp_role).'</td></tr>';

$final_word.='<tr>	<td  align="left" class="general-bodyBold" valign="top"><strong>Team Size</strong>:</td><td colspan="5" style="text-align:justify;">'.stripslashes($work_exp->wp_team_size).'</td></tr>';
	...
	$final_word.='<tr>	<td  align="left" class="general-bodyBold" valign="top"><strong>Description</strong>:</td><td colspan="5" style="text-align:justify;">'.stripslashes($work_exp->wp_description).'</td></tr>
	  <tr>	<td  align="left" class="general-bodyBold" valign="top"><strong>Tools Used </strong>:</td><td colspan="5">'.stripslashes($work_exp->wp_tools).'</td></tr>
         <tr><td style="height: 1px;" colspan="6" bgcolor="#999999" ></td></tr>   </tr>';
		  $final_word.='<tr>	<td  align="left" class="general-bodyBold" valign="top"><strong>Deliverable/Challenges Faced</strong>:</td><td colspan="5" style="text-align:justify;">'.stripslashes($work_exp->wp_challenges).'</td></tr>';
 }}
...
if($members->m_father_name != ''){ 
 ...
 $final_word.=' <tr>
  ...
  <tr>
    ...
    <td>: ';
	if($members->m_gender=='male') $final_word.='Male';
