...
'".$jp_suggested_read."',
		...
		$html='Dear';
     			 $from='rvvlsi@gmail.com';
				 $to      = $email;
				 $subject = 'Edit job posting' ;
				 $message = $html;
...
<body onload="showaggrementbond(<?php echo $jp_bonddetails;?>')">
<div class="container">
<div class="dashboard">
<div id="table">
 ...
 <?php for($i=0;$i<count($arrbranch);$i++){?>
  ...
  <tr>
    ...
    <td><select name="select3[]"  multiple="multiple" id="select3[]" style="width:250px;">
      ...
      <option value="2" <?php if($cltexperience='1'){echo "Selected";}?>>Experienced</option>
    </select></td>
  </tr>
  <tr>
    ...
    <td><table width="150" border="0" cellspacing="1" cellpadding="3" style="background-color:#CCCCCC;">
      ...
      <tr style="background-color:#FFFFFF;">
        ...
        <td><form id="form2" name="form1" method="post" action="">
          <input name="textfield12" type="text" id="textfield12" size="10" value="<?php echo $cltquarterly;?>" maxlength="6" onKeyPress='return numbersonly(event);'/>
        </form></td>
      </tr>
      <tr style="background-color:#FFFFFF;">
        <td nowrap="nowrap">Annualy</td>
        <td><input name="textfield13" type="text" id="textfield13" size="10" value="<?php echo $cltannualy;?>" maxlength="6" onKeyPress='return numbersonly(event);'/></td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
<input type="radio" name="checkbox10" value="no" onclick="showaggrementbond(this.value);" <?php if($cltcheckbox10=='no'){?>checked="checked"<?php }?>>No</td>
  ...
  <tr id="mentionbonddetails">
    <td nowrap="nowrap" class="alignright">Mention Details of Bond</td>
        <td><input name="aggrementbondyear" type="text" id="aggrementbondyear" name="aggrementbondyear" style="width:80px;" value="<?php echo $jp_bonddetails;?>"/></td>
      </tr>
    <tr>
