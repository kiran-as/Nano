...
<table width="900" border="0" cellspacing="4" cellpadding="2">
 ...
 <option value="1" <?php if(in_array('1',$cltcourse)){echo "Selected";}?>>P.G Diploma</option>
      <option value="2" <?php if(in_array('2',$cltcourse)){echo "Selected";}?>>BE/B.Tech</option>
      <option value="3" <?php if(in_array('3',$cltcourse)){echo "Selected";}?>>M.E/M.Tech</option>
      <option value="4" <?php if(in_array('4',$cltcourse)){echo "Selected";}?>>M.Sc</option>
      <option value="5" <?php if(in_array('5',$cltcourse)){echo "Selected";}?>>B.E after B.Sc</option>
      <option value="6" <?php if(in_array('6',$cltcourse)){echo "Selected";}?>>B.Sc</option>
      <option value="7" <?php if(in_array('7',$cltcourse)){echo "Selected";}?>>M.sc</option>
      <option value="8" <?php if(in_array('8',$cltcourse)){echo "Selected";}?>>Certificate Courses</option>
  ...
  <tr>
    ...
    <span class="small">If recruiting for Embedded Systems</span><br>
     <select name="selectembedded[]" size="15"  multiple="multiple" id="selectembedded" style="width:300px;">
      <option value="1" <?php if(in_array('1',$cltembedded)){echo "Selected";}?>>Overview of Embedded Systems Development</option>
      <option value="2" <?php if(in_array('2',$cltembedded)){echo "Selected";}?>>Hardware Fundamentals</option>
      <option value="3" <?php if(in_array('3',$cltembedded)){echo "Selected";}?>>In depth C Programming Skills</option>
      <option value="4" <?php if(in_array('4',$cltembedded)){echo "Selected";}?>>C++ Programming Skills</option>
      <option value="5" <?php if(in_array('5',$cltembedded)){echo "Selected";}?>>Data Structures</option>
      <option value="6" <?php if(in_array('6',$cltembedded)){echo "Selected";}?>>Scripting Using PERL</option>
      <option value="7" <?php if(in_array('7',$cltembedded)){echo "Selected";}?>>Microcontroller Programming</option>
      <option value="8" <?php if(in_array('8',$cltembedded)){echo "Selected";}?>>OS Basics</option>
      <option value="9" <?php if(in_array('9',$cltembedded)){echo "Selected";}?>>EOS Basics</option>
      <option value="10" <?php if(in_array('10',$cltembedded)){echo "Selected";}?>>RTOS Basics</option>
      <option value="11" <?php if(in_array('11',$cltembedded)){echo "Selected";}?>>IP Networking</option>
</select>
      <br />
...
<input type="radio" name="select5" value="0" <?php if($cltdurations=='0'){?>checked="checked"<?php }?>>3 Months
<input type="radio" name="select5" value="1" <?php if($cltdurations=='1'){?>checked="checked"<?php }?>>6 Months
<input type="radio" name="select5" value="2" <?php if($cltdurations=='2'){?>checked="checked"<?php }?>>1 Year
