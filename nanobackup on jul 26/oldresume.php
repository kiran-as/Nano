...
<tr><td width="26%" class="error" align="center"><div style="border:1px solid #ccc; padding:5px;">	<? if($members->m_resume_status !=1){?>Your resume is not yet activated. Please go to Step 5 and submit your resume<? }else{?>A complete resume has a higher probability of being shortlisted for interviews. We suggest you to keep your resume updated and complete for a better chance of being selected.<? }?></div></td></tr>
<tr>
...
<? } ?></span><br />
Ph.No : <?=$members->m_phone; ?><span style="float:right;"></span><span style="float:right">Employability Factor :&nbsp;&nbsp;<?=employabilityFactor($_SESSION[m_id])?>&nbsp;&nbsp;</td>
</tr>
  ...
  <table width="100%" border="0" cellspacing="3" cellpadding="3">
         <tr>
              ...
              <tr>
                ...
                <td align="left" class="general-bodyBold"><strong>Role</strong>:</td><td colspan="5"><?=$work_exp->wp_role;?></td></tr>
	    ...
	    <td  align="left" class="general-bodyBold" ><strong>Team Size</strong>:</td><td colspan="6" style="text-align:justify;"><?=stripslashes($work_exp->wp_team_size);?></td></tr>
	            <tr>
