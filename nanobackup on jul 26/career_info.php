...
{
	window.location="http://nanochipsolutions.com/personal_info.php";
}
...
<form action="career_info.php" method="POST" name="careerinfo" id="careerinfo" onsubmit="return fnvalidatess();">
...
<ul id="menu">
   ...
   <li><a href="educations_info.php" title="Academic Qualification">Academic Qualification</a></li>
      ...
      <li><a href="academic_info.php" title="Academic Projects">Academic Projects</a></li>
	     <li><a href="work_info.php" title="Work Experience">Work Experience</a></li>
		    <li><a href="career_info.php" title="Career Details"       class="current">Career Details</a></li>
...
<!--<table width="100%" cellpadding="3" cellspacing="3" border="0"><tr><td align="right"><a href="resume.php"><img src="images/submitnviewbg.png" border="0" /></a></td></tr></table>-->
