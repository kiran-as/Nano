...
{
    alert('asdf');
   window.location="http://nanochipsolutions.com/1_academic_info.php";
}
</script>
 ...
 <form action="" method="POST"  name= "myform" onSubmit="return academicinfovalidation_pop();">
                    <table>
						...
						<tr>
                            ...
                            <td><input type="text" name="title" id="title" value="<?php echo $ptitile;?>"/></td>
						...
						<tr>
                            ...
                            <td><input type="text" name="period" id="period" value="<?php echo $period;?>"/></td>
