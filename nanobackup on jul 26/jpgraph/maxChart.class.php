...
class maxChart {
   ...
   var $width = 20;  // The chart box width 
   ...
   function displayChart($title='', $type, $width=300, $height=200, $variousColor=false){
      ...
      echo '<div class="chartbox" style="width:300px; height:'.$this->height.'px;">
                <h2>'.$this->title.'</h2>'."\r\n";
   ...
   function drawVertical(){
      ...
      foreach ($this->data as $key=>$value) {
	     ...
	     echo '    <div><img src="style/images/bar'.$color.'.png" style="width:30px; height:'.$a.'px;" /></div>'."\r\n";
         echo '    <div class="barvvalue" valign="top" style="width:'.$barw.'px;">'.$key.'</div>'."\r\n";
         echo '  </div>'."\r\n";
