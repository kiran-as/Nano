...
if($student_10th[0]->e_percentage>=60 && count($student_10th)!=0){
$rv_marks+=5;
}
...
if($student_12th[0]->e_percentage>60 && count($student_12th)!=0){
$rv_marks+=5;
}
...
$rv_marks+=25;
  ...
  $student_be=$db->getResults("select * from rv_educational_details where m_id='".$m_id."' and qua_id='2' and e_course='25' ");

if(count($student_be)!=0){

// b.tech in NIT,IIT AND ISSC
if($student_be[0]->e_institute=='314' || $student_be[0]->e_institute=='459' || $student_be[0]->e_institute=='671'){
