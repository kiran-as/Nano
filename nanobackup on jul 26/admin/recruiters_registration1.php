...
if(count($result)!=0)
{
echo  "<script>document.location.href='recruiters_registration1.php?success=6'</script>";
...
$result=$db->insertRecord($info_query);
    ...
    $headers .= 'From: Nanochipsolution <info@nanochipsolutions.com>';
				...
				$subject='Nanochip Solutions: New Registration by Recruiter';
...
<table width="900" border="0" cellspacing="4" cellpadding="2">
    ...
    <tr>
     ...
     <td valign="top" nowrap="nowrap" class="alignright">Full Name*</td>
     <td width="225"><?=$input->textBox('txtUserName',$_REQUEST[txtUserName]);?></td>
...
<td><input type="text" name="txtEmail" value="<?=$_REQUEST[txtEmail]?>" onBlur="return validEmail(this.value)"/>
...
<tr>
    ...
    <td><?=$input->textArea('txtAddress','','text');?></td>
...
<td><input type="text" name="txtPinCode" value="<?=$_REQUEST[txtPinCode]?>" onClick="return numbersonly(event);"/></td>
 <!--<td><?=$input->textBox('txtPinCode',$_REQUEST[txtPinCode],'return numbersonly(event);');?></td>
...
<td valign="top" nowrap="nowrap" class="alignright">STD Code/Contact No*</td>
<td><?=$input->textBox('txtStdCode');?></td>
...
<td valign="top" nowrap="nowrap" class="alignright">Mobile Number:*</td>
...
<td valign="top" nowrap="nowrap" class="alignright">Web Site Url:*</td>
...
<td><?=$input->textBox('txtIndustry',$_REQUEST[txtIndustry]);?></td>
