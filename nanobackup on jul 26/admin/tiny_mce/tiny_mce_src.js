...
TinyMCE_Engine.prototype = {
	...
	updateContent : function(form_elemenqua_title) {
		var formElement, n, inst, doc;

		// Find MCE instance linked to given form element and copy it's value
		formElement = document.getElementById(form_elemenqua_title);
	...
	addMCEControl : function(replace_element, form_elemenqua_title, target_document) {
		...
		inst._onAdd(replace_element, form_elemenqua_title, target_document);
	},
...
//		return this.contentDocument ? this.contentDocument : this.contentWindow.document; // Removed due to IE 5.5 ?
	...
	_onAdd : function(replace_element, form_elemenqua_title, target_document) {
		...
		this.formTargetElementId = form_elemenqua_title;
		...
		if (replace_element.nodeName != "TEXTAREA" && replace_element.nodeName != "INPUT") {
			...
			// Debug mode
			hc = '<input type="hidden" id="' + form_elemenqua_title + '" name="' + form_elemenqua_title + '" />';
