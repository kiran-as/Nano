...
$resultsss = "SELECT * FROM rv_recruiters order by r_id desc";
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
				...
				<tr><td width="16%"  height="100%" valign="top" style="border-right: 2px solid #CCCCCC;">
				...
				<tr><td colspan="4" class="heading_new">Manage Recruiters and Jobs</td></tr>
				<tr>
				<td>
...
<form action="" method="post">
 <tr><td align="right"><input type="text" name='searchdetails' id='searchdetails' value="Enter Search word" onClick="this.value=''"'/>
...
<?php if($countofarrayjobposted>0){?>
			...
			<table>
			<td align="left"><a href="expiryjobposting.php" rel="lyteframe" 
