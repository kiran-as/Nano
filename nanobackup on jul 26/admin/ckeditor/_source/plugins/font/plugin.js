...
(function()
{
	...
	CKEDITOR.plugins.add( 'font',
	{
		...
		init : function( editor )
		{
			...
			addCombo( editor, 'Font', 'family', editor.lang.font, config.fonqua_titles, config.font_defaultLabel, config.font_style );
 ...
 * @type String
 * @example
 * config.fonqua_titles =
 *     'Arial/Arial, Helvetica, sans-serif;' +
 *     'Times New Roman/Times New Roman, Times, serif;' +
 *     'Verdana';
 * @example
 * config.fonqua_titles = 'Arial;Times New Roman;Verdana';
 */
CKEDITOR.config.fonqua_titles =
	'Arial/Arial, Helvetica, sans-serif;' +
