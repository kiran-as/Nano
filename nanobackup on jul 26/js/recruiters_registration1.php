...
$().ready(function() {
	...
	function fnclose()
{
  window.location="recruiter_index1.php";
}	
...
<td></td>
<td align="left"><input type="checkbox" name="tandc" id="tandc" value=""><a href="#">I accept the Terms and Condition</a>
</td>
</tr>
  <tr>

    <td colspan="2"  align="right">
    <input  type="submit" value="Save" name="regSubmit" class="blueButton" onclick="fnvalidateterms();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="close" id="close" name="close" class="grayButton" value="Close" onclick="fnclose();"></input>
       </tr>
</table>
<?php } else {?>
