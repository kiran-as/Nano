...
if (empty($idcompanies)) {
    ...
    if (($oldCompanyName != '') && ($oldDesignation != '') && ($oldFromMonth != '') && ($oldToYear != '') && ($oldFromYear != '')) {
...
<select class='form-control' placeholder='From Year' style='width:84px;' name='oldFromMonth[]'>
    ...
    } $table.=" $selected>Jan</option>
                  <option value='2'";
    if ($frommonth == '2') {
	$table.=" Selected=Selected";
    } $table.=" $selected>Feb</option>
                  <option value='3'";
    if ($frommonth == '3') {
	$table.=" Selected=Selected";
    } $table.=" $selected>March</option>
                  <option value='4'";
    if ($frommonth == '4') {
	$table.=" Selected=Selected";
    } $table.=" $selected>April</option>
                  <option value='5'";
    if ($frommonth == '5') {
	$table.=" Selected=Selected";
    } $table.=" $selected>May</option>
                  <option value='6'";
    if ($frommonth == '6') {
	$table.=" Selected=Selected";
    } $table.=" $selected>June</option>
                  <option value='7'";
    if ($frommonth == '7') {
	$table.=" Selected=Selected";
    } $table.=" $selected>July</option>
                  <option value='8'";
    if ($frommonth == '8') {
	$table.=" Selected=Selected";
    } $table.=" $selected>Aug</option>
                  <option value='9'";
    if ($frommonth == '9') {
	$table.=" Selected=Selected";
    } $table.=" $selected>Sep</option>
                  <option value='10'";
    if ($frommonth == '10') {
	$table.=" Selected=Selected";
    } $table.=" $selected>Oct</option>
                  <option value='11'";
    if ($frommonth == '11') {
	$table.=" Selected=Selected";
    } $table.=" $selected>Nov</option>
                  <option value='12'";
    if ($frommonth == '12') {
	$table.=" Selected=Selected";
    } $table.=" $selected>Dec</option>
               </select>
    </div>
    <div class='form-group col-sm-1'>
<select class='form-control'  style='width:84px;' name='oldFromYear[$i]'>
	...
	$table.="<option value='$valueYear'";
	if ($fromyear == $valueYear) {
	    $table.="Selected=Selected";
	} $table.=">
                      $valueYear
                      </option>";
