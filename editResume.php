...
<?php if($corecompetancyArray[5]['corecompetancy']!=''){?>
<li><textarea  class="form-control mar-b15" rows="2"  name="corecompetancy[]" value=''><?php echo $corecompetancyArray[5]['corecompetancy'];?></textarea></li>    <?php }?>
<?php if($corecompetancyArray[6]['corecompetancy']!=''){?>
<li><textarea  class="form-control mar-b15" rows="2"  name="corecompetancy[]" value=''><?php echo $corecompetancyArray[6]['corecompetancy'];?></textarea></li>    <?php }?>
<?php if($corecompetancyArray[7]['corecompetancy']!=''){?>
<li><textarea  class="form-control mar-b15" rows="2"  name="corecompetancy[]" value=''><?php echo $corecompetancyArray[7]['corecompetancy'];?></textarea></li>    <?php }?>
<?php if($corecompetancyArray[8]['corecompetancy']!=''){?>
<li><textarea  class="form-control mar-b15" rows="2"  name="corecompetancy[]" value=''><?php echo $corecompetancyArray[8]['corecompetancy'];?></textarea></li>    <?php }?>
<?php if($corecompetancyArray[9]['corecompetancy']!=''){?>
<li><textarea  class="form-control mar-b15" rows="2"  name="corecompetancy[]" value=''><?php echo $corecompetancyArray[9]['corecompetancy'];?></textarea></li>    <?php }?>
